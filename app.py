...
# ANA EKRAN MANTIĞI: DUVARLA AYRILMIŞ İKİ EVREN
main_placeholder = st.empty()

if live_mode:
    # EVREN 1: SADECE TELEMETRİ (SHAP'a dair tek bir harf bile yok)
    ...
    # EVREN 2: SADECE TEKİL ANALİZ, SCADA VE SHAP
    with main_placeholder.container():
            ...
            with st.spinner('Yapay Zeka FD004 Verilerini Analiz Ediyor...'):
                ...
                with st.expander("🧠 XAI: Model Karar Mekanizmasını İncele (SHAP Görseli)", expanded=False):
                    ...
                    with st.spinner('Matris grafiği çiziliyor...'):
                        ...
                        plt.close(fig) # MATPLOTLIB HAFIZA TEMİZLİĞİ İÇİN ŞART!

# FOOTER KESİNLİKLE EN ALTTA
st.sidebar.markdown("---")
